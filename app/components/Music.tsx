...
function AlbumCard({ album }: { album: Album }) {
  ...
  return (
    <div className="music-release-card w-full text-center">
      <h3 className="music-release-heading mb-3 font-display text-[26px] font-bold uppercase leading-none tracking-wide text-white sm:text-[28px] md:text-[30px]">
        {album.href ? (
          <a
            href={album.href}
            target="_blank"
            rel="noreferrer noopener"
            className="music-release-link inline-flex items-center justify-center gap-2 text-white focus-visible:rounded-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white"
          ...
          <span
            className="music-release-link inline-flex cursor-not-allowed items-center justify-center gap-2 text-white"
